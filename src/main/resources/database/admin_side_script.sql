...
AS
	SELECT e.employee_id, CONCAT(e.first_name, ' ' , e.last_name) as Name, e.age, e.job_title, d.department_name, b.name as branch_name
	FROM employee AS e
...
UPDATE department SET department_head='Mira Rao' WHERE department_id=1;

UPDATE department SET department_head='Sneha Yadav' WHERE department_id=2;

UPDATE department SET department_head='Deepika Singh' WHERE department_id=3;

UPDATE department SET department_head='Isha Malhotra' WHERE department_id=4;

UPDATE department SET department_head='Isha Malhotra' WHERE department_id=5;

 UPDATE department SET department_head='Raman Chawla' WHERE department_id=6;
 
UPDATE department SET department_head='Mihir Shah' WHERE department_id=7;

UPDATE department SET department_head='Rajesh Nayar' WHERE department_id=8;

UPDATE department SET department_head='Vikram Trivedi' WHERE department_id=10;

UPDATE department SET department_head='Kavya Thakur' WHERE department_id=12;

ALTER TABLE department ADD department_head_id INT, ADD FOREIGN KEY department(department_head_id) REFERENCES employee(employee_id);

UPDATE department SET department_head_id='19' WHERE department_id=1;

UPDATE department SET department_head_id='27' WHERE department_id=2;

UPDATE department SET department_head_id='37' WHERE department_id=3;

UPDATE department SET department_head_id='66' WHERE department_id=5;

UPDATE department SET department_head_id='48' WHERE department_id=6;

UPDATE department SET department_head_id='79' WHERE department_id=7;
 
UPDATE department SET department_head_id='90' WHERE department_id=8;

UPDATE department SET department_head_id='101' WHERE department_id=10;

UPDATE department SET department_head_id='114' WHERE department_id=12;



UPDATE home_loan_application SET motto_purchase='Primary Residence';

UPDATE personal_loan_application SET loan_purpose='Medical';

UPDATE personal_loan_application SET loan_purpose='Medical';
UPDATE home_loan_application SET marital_status='Single';
UPDATE personal_loan_application SET marital_status='Single';
UPDATE gold_loan_application SET marital_status='Single';

UPDATE home_loan_application SET work_mode='On-Site Work';
UPDATE personal_loan_application SET work_mode='On-Site Work';
UPDATE gold_loan_application SET work_mode='On-Site Work';

UPDATE gold_loan_application SET loan_purpose='Home Improvements';

UPDATE gold_loan_application SET gold_ornament='Chain, Rings';

ALTER TABLE home_loan_application ADD COLUMN approved VARCHAR(50) DEFAULT 'no';
ALTER TABLE personal_loan_application ADD COLUMN approved VARCHAR(50) DEFAULT 'no';
ALTER TABLE gold_loan_application ADD COLUMN approved VARCHAR(50) DEFAULT 'no';


SELECT COUNT(*) FROM transaction_history GROUP BY created_at HAVING created_at=NOW();

SELECT SUM(amount) FROM transaction_history WHERE status='Success' AND transaction_type IN ('Transfer', 'Withdraw', 'Payment');

SELECT SUM(amount) FROM transaction_history WHERE status='Success' AND transaction_type IN ('Deposit', 'Reception');