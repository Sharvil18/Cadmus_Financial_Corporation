...
public class PersonalLoanPDFExporter {
    private PersonalLoanApplication personalLoanApplication;
    private LoanLog loanLog;

    public PersonalLoanPDFExporter(PersonalLoanApplication personalLoanApplication, LoanLog loanLog) {
        this.personalLoanApplication = personalLoanApplication;
    ...
    public byte[] export() throws DocumentException, IOException {
        ...
        Paragraph p = new Paragraph("Personal Loan Information", font);
    ...
    private void addContent(Document document) throws DocumentException {
        ...
        String name = personalLoanApplication.getFirst_name() + " " + personalLoanApplication.getLast_name();
        String applicationNumber = personalLoanApplication.getApplication_number();
        String email = personalLoanApplication.getEmail();
        String contact = personalLoanApplication.getContact();
        String age = String.valueOf(personalLoanApplication.getAge());
        String birthDate = String.valueOf(personalLoanApplication.getBirth_date());
        String address = personalLoanApplication.getAddress_house() + ", " + personalLoanApplication.getAddress_complex() + ", \n" +
                personalLoanApplication.getAddress_street_line1() + ", " + personalLoanApplication.getAddress_street_line2() + ".";
        String city = personalLoanApplication.getAddress_city();
        String state = personalLoanApplication.getAddress_state();
